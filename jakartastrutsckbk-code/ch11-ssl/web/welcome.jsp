...
<ul>
<li><html:link action="/reg/Main">Main Menu</html:link> (must be logged on)</li>
<li><html:link action="/admin/Main">Administrative Menu</html:link> (must be logged on)</li>
</ul>
</body>
</html>