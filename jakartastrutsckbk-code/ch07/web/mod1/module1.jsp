...
<h2>Struts Cookbook - Chapter 6 : Module 1</h2>
  ...
  <p>
    <html:link forward="goToDefaultModule">Link To Default Module using Global Forward</html:link>
  </p>
  <p>
    <html:link forward="goToDefaultModule2">Link To Default Module using Global Forward(2)</html:link>
  </p>
</body>
</html>
